...
}, PANEL_HEIGHT = 32, TAG_DOCUMENT_NAME = "media.tag", TAGS_PANEL_WIDTH = 250, CATEGORY_DOCUMENT_NAME = "category.tag", debugThrottle = (throttled) => function(source) {
  return rxjs.iif(
    () => !!throttled,
    source.pipe(
...
const plugin = {
  ...
  schema: {
    types: [mediaTag, mediaTagCategory]
  },
